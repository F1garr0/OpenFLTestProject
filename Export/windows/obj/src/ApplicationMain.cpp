...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("DisplayingABitmap",10,ef,65,0e),::ApplicationMain_obj::create_dyn());
...
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("OpenFL",b0,bb,28,56));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("DisplayingABitmap",10,ef,65,0e));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Displaying a Bitmap",0e,fe,84,88));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("org.openfl.samples.displayingabitmap",f7,11,96,22));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Displaying a Bitmap",0e,fe,84,88))
